...
public abstract class IDD_SelfDefiningField implements IAFPDecodeableWriteable{
		...
		public SelfDefiningFieldType getFieldType() { return fieldType; }
		public void setFieldType(SelfDefiningFieldType fieldType) { this.fieldType = fieldType; }
	...
	public static class IOCAFunctionSetIdentification extends IDD_SelfDefiningField{
		public static enum FunctionSetIdentifier{
			...
			public static IOCAFunctionSetIdentification.FunctionSetIdentifier valueOf(byte fsCodeByte){
				for(IOCAFunctionSetIdentification.FunctionSetIdentifier fsi : values()) if(fsi.code==fsCodeByte) return fsi;
				return null;
			}
	...
	public static enum SelfDefiningFieldType{
		...
		;
		int fieldType;
		SelfDefiningFieldType(int fieldTypeByte){this.fieldType = fieldTypeByte;}
		...
		public int toByte(){ return fieldType;}
	}
