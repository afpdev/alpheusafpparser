...
requirements for data presented on physical media and for operations performed
on physical media. The scope of the Presentation Fidelity Control structured field
is the document or print file controlled by the form map that contains this
structured field.
 * <br><br>
Triplets are used on the Presentation Fidelity Control structured field to define
specific presentation fidelity requirements that are to be applied by the
presentation process as data is presented on physical media. While triplets may be
conceptually related, each triplet is processed independently of any other triplet.
Therefore, it is the responsibility of the generator of the Presentation Fidelity
Control structured field to ensure cross-triplet consistency. If a particular fidelity
triplet is not specified on this structured field, or if this structured field is not
