...
/**
 *  Programming Guide and Line Data Reference(ha3l3r04.pdf), page 104.<br>
 *  <br>
 * The Line Descriptor structured field contains information, such as line position,
text orientation, font selection, field selection, and conditional processing
identification, used to format line data.
 */
public class LND_LineDescriptor extends StructuredFieldBaseTriplets {
	public static enum LND_Flag implements IMutualExclusiveGroupedFlag{
		...
		int group;
		LND_Flag(int group){this.group = group;}
		@Override
