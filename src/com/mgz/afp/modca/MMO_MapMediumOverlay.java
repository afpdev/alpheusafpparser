 ...
 * MO:DCA, page 287.<br>
 *<br> 
The Map Medium Overlay structured field maps one-byte medium overlay local
identifiers that are specified by keywords in the Medium Modification Control
(MMC) structured field to medium overlay names.
 */
public class MMO_MapMediumOverlay extends StructuredFieldBaseRepeatingGroups{
	...
	public static class MMO_PrepeatingGroup implements IRepeatingGroup{
		...
		/**
		 * Shows whether the overlay is to be loaded into the printer as a raster
		 * pattern overlay or as a coded overlay:
		 */
