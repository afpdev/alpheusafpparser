 ...
 * MO:DCA, page 233.<br>
 * <br>
The Map Coded Font structured field maps a unique coded font resource local ID,
which may be embedded one or more times within an object's data and descriptor,
to the identifier of a coded font resource object. This identifier may be specified in
one of the following formats:
<ul>
<li> A coded font Global Resource Identifier (GRID)
<li> A coded font name
<li> A combination of code page name and font character set name
</ul>
Additionally, the Map Coded Font structured field specifies a set of resource
attributes for the coded font. For a description of coded fonts, see the Font Object
