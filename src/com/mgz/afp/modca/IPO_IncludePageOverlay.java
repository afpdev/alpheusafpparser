...
/**
 * MO:DCA, page 217.<br>
 * andProgramming Guide and Line Data Reference(ha3l3r04.pdf), page 101.<br>
 * <br>
 * The Include Page Overlay structured field references an overlay resource definition
that is to be positioned on the page. A page overlay can be referenced at any time
during the page state, but not during an object state. The overlay contains its own
active environment group definition.
The current environment of the page that included the overlay is restored when
the Include Page Overlay has been completed.
 * <br>
 * <br>
The Include Page Overlay structured field references an overlay resource object
that is to be positioned on the page. The overlay contains its own Active
Environment Group. For line-mode and mixed-mode applications only, a value of
X'FFFFFF' may be used for either the {@link #xOrigin}, the {@link #yOrigin}, or both.
 */
