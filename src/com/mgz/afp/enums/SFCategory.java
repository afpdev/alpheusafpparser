...
/**
 * The structured field category code. It identifies the lowest
level component that can be constructed using the
structured field, such as document, active environment
group, page, or object. The same category code point
assigned to a component's begin structured field also is
assigned to that component's end structured field. These
code points identify and delimit an entire component
within a data stream or an encompassing component. See
“Category Codes” on page 23 for a description of category
codes.
 */
