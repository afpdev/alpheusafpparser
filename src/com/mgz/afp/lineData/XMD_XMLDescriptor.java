...
public class XMD_XMLDescriptor extends StructuredFieldBaseTriplets {
	public static enum XMD_Flag{
		...
		int group;
		XMD_Flag(int group){ this.group=group;}
		...
		public static EnumSet<XMD_Flag> valueOf(int flagBytes){
			...
			if((flagBytes & 0x000001)!=0) result.add(HaiderTrailerContinued_IsAContinuationOfHeaderTrailer);
		...
		public static byte[] toBytes(EnumSet<XMD_Flag> flags){
			...
			// 0x000002 is not used.
			if(flags.contains(HaiderTrailerContinued_IsAContinuationOfHeaderTrailer)) result|=0x000001;
