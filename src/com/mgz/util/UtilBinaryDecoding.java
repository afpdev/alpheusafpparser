...
public class UtilBinaryDecoding {
	...
	/**
	 * Converts the given short value to an array of byte of given length.
	 * In Java a short value has the size of 2 bytes.
	 * @param value
	 * @param nrOfBytes
	 * @return
	 */
	 ...
	 * In Java an int value has the size of 4 bytes.
	 * @param value
	 * @param nrOfBytes
	 * @return
	 */
