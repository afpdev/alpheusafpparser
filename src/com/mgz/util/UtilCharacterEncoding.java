...
public class UtilCharacterEncoding {
	 ...
	 * Hex digits are: 0123456789ABCDEF.
	...
	/**
	 * Converts the given {@link String} into a byte array of given length using the given {@link Charset} for encoding.
	 * If the encoded bytes of the given {@link String} is shorter than the given length, the additional encoded bytes are filled with given byte filler.
	 * If the encoded bytes of the given {@link String} is longer than the given length, the additional encoded bytes are truncated. 
	 * 
	 ...
	 * @param filler byte used for pedding if encoded string is shorter than given length.
	 ...
	 * The given String may or may not contain spaces and hex prefixes ("0x").
	 * The  
	 * @param text 
