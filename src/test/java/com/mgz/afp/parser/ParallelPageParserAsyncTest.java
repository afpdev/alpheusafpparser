...
class ParallelPageParserAsyncTest {

  @Test
  void testParallelParsingWithAsyncChannel() throws Exception {
    ...
    // 2. Parallel parsing with AsyncChannel (bypass MappedByteBuffer)
    AFPParserConfiguration parConfig = new AFPParserConfiguration() {
      @Override
      public java.nio.MappedByteBuffer getByteBuffer() {
        return null; // Force null to test AsyncChannel path
      }
    };
